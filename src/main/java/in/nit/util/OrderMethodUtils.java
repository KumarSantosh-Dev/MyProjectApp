...
public class OrderMethodUtils {
	...
	public void generatePie(String path,List<Object[]> data) {
		...
		//Save Image as using ChartUtils
		   try {
			ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/orderTypePie.jpg"), chart, 400, 400);
		} catch (IOException e) {
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		//create JFreeChart using ChartFactory
		JFreeChart chart=ChartFactory.createBarChart("OrderMethod Types", "TYPES", "COUNT", dataset);
		//Save Image as using ChartUtils
		   try {
			ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/orderTypeBar.jpg"), chart, 400, 400);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
